...
train.data2 <- ddply(train.data2, 
      .(Title), 
      transform, 
      Age=ifelse(is.na(Age), median(Age, na.rm=TRUE), Age)) # ré-organiser en fonction du titre
...
(model <- randomForest(Survived~., data = train.titanic, ntree = 200, na.action = na.omit(train.titanic)))
```
